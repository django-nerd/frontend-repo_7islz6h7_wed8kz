    ...
    <section id="gallery" className={`${darkMode ? 'bg-black' : 'bg-[#F5F2E8]'} py-16 sm:py-24`}>
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-10 flex justify-center">
          <a
            href="#contact"
            className={`inline-flex items-center gap-2 rounded-full px-5 py-2 border ${darkMode ? 'border-neutral-700 text-white hover:bg-neutral-900' : 'border-neutral-300 text-black hover:bg-white'} transition`}
          >
            View Full Gallery
          </a>
        </div>
